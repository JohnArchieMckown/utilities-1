...
BALR     OPSYN BASR
         ...
         SYSSTATE ASCENV=P,                                            X
               AMODE64=NO,                                             X
               ARCHLVL=2
AXREXX   CEEENTRY PPA=AXREXX_PPA,                                      X
               MAIN=YES,                                               X
               AUTO=DSASIZE,                                           X
               BASE=R11_32
AXREXX   ALIAS C'axrexx'
         USING CEECAA,R12_32
         USING CEEDSA,R13_32
         J     GO
GOBACK   DS    0H
...
* Use sprintf to make a nice looking message.
         ...
         LA    R1_32,CALLX
         CEEPCALL BPX1WRT,(STDOUT,BUFFERA,ALET,COUNT,                  X
               RETVAL,                                                 X
               RETCODE,                                                X
               RSNCODE),VL,                                            X
               MF=(E,(1))
...
TOUPPER  DC    256AL1(*-TOUPPER)
         ...
         ORG
         LTORG *
AXREXX_PPA CEEPPA LIBRARY=NO,                                          X
               PPA2=YES,                                               X
               EXTPROC=YES,                                            X
               TSTAMP=YES,                                             X
               PEP=YES,                                                X
